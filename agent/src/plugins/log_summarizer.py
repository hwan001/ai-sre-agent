...
def create_log_summary_client() -> Optional[AzureOpenAIChatCompletionClient]:
...
def get_log_summarizer_tools(model_client: Optional[AzureOpenAIChatCompletionClient] = None) -> List[Callable]:
    """
